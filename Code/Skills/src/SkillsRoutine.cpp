...
arms::chassis::move({40, -100}, 100, arms::REVERSE);      //Side goal slam
...
//arms::chassis::move({58, -56});    //Drive to center bar //55 to 43
        arms::chassis::move({54, -56});    //Drive to center bar //55 to 43
...
arms::chassis::move({57, -93}, 100);    //Goal slam 3 64
flapL.set_value(false);
flapR.set_value(false);
...
arms::chassis::move({0, -70}, 90);      //Drive to elevation bar 130
...
arms::chassis::move({0, -32}, 100);      //Drive to elevate 131
