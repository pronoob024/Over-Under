...
arms::chassis::move({35, 12}, 100);
flapR.set_value(false);
arms::chassis::move({20, 12}, 100, arms::REVERSE);
//pros::delay(250);
...
flapL.set_value(false);
flapR.set_value(false);
arms::chassis::move({70, -50}, 90, arms::REVERSE);   //Back up to far position
arms::chassis::move({50, -50}, 90, arms::REVERSE);   //Back up to far position
