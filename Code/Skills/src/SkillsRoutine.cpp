...
arms::chassis::turn(225, 75);
arms::chassis::move({2, -15}, 70);      //Drive to other side
arms::chassis::move({3, -80}, 80);      //Drive to other side
pros::delay(50); 

arms::chassis::move({20, -102}, 80);      //Side goal slam
//flapL.set_value(true);
arms::chassis::move({40, -102}, 90);      //Side goal slam
flapL.set_value(false);
pros::delay(150);

arms::chassis::move({28, -90}, 80, arms::REVERSE);     //Drive away from goal
intakeMotor.moveVoltage(-4000);
...
arms::chassis::move({64, -94}, 80);    //Goal slam 2 -6
flapL.set_value(false);
flapR.set_value(false);
pros::delay(100);
